      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <div className="max-w-2xl">
          ...
          <p className="text-xs md:text-sm text-textMuted font-medium leading-relaxed">
            Configure your professional profile and global portal architecture.
          </p>
        </div>
      </div>
        ...
        <div className="flex-1 p-4 md:p-8 lg:p-10">
            ...
            <div className="space-y-6 animate-fade-in max-w-4xl">
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5 pb-6 border-b border-slate-100">
                ...
                <div className="text-center sm:text-left pt-2">
                  ...
                  <div className="flex flex-wrap justify-center sm:justify-start gap-2 mt-4">
                    <span className="px-4 py-1.5 bg-secondary text-primary rounded-xl text-[9px] font-black uppercase tracking-[0.2em] shadow-sm">
                      Root Admin
                    </span>
                    <span className="px-4 py-1.5 bg-slate-100 text-slate-500 rounded-xl text-[9px] font-black uppercase tracking-[0.2em] border border-slate-200">
                      System Key: PRV-001
                    </span>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-primary uppercase tracking-[0.25em] ml-1">
                    Identity Label
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl focus:ring-4 focus:ring-secondary/10 focus:border-secondary focus:outline-none transition-all text-sm font-bold"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-primary uppercase tracking-[0.25em] ml-1">
                  ...
                  <input
                    ...
                    value={profile.email}
                    readOnly
                    className="w-full px-4 py-3 bg-slate-100 border border-slate-200 rounded-xl text-slate-400 cursor-not-allowed text-sm font-bold"
                  />
                  <p className="text-[9px] text-slate-400 uppercase font-black tracking-tighter ml-1">
                ...
                <div className="col-span-1 md:col-span-2 space-y-2">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl focus:ring-4 focus:ring-secondary/10 focus:border-secondary focus:outline-none resize-none transition-all text-sm font-bold"
                  />
                </div>
              </div>
              ...
              <div className="flex justify-end pt-6 border-t border-slate-100">
                <button
                  ...
                  className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-primary text-white rounded-xl hover:bg-slate-800 shadow-lg transition-all active:scale-95 text-[11px] font-black uppercase tracking-[0.3em]"
                >
                  {isProfileSaved ? (
          ...
          {activeTab === "system" && (
            <div className="space-y-6 animate-fade-in max-w-4xl">
              ...
              <div className="space-y-4">
                <div className="group p-5 bg-slate-50 border border-slate-100 rounded-2xl flex justify-between items-center gap-5 hover:bg-white hover:border-secondary/30 hover:shadow-xl transition-all">
                  <div className="flex items-center gap-4 min-w-0">
                    ...
                    <div className="min-w-0">
                      <h4 className="font-black text-primary text-sm md:text-base tracking-tight leading-none mb-2">
          ...
          {(activeTab === "team" || activeTab === "security") && (
            <div className="flex flex-col items-center justify-center h-full text-center py-12 animate-fade-in">
              <div className="w-16 h-16 bg-slate-50 text-slate-200 p-5 rounded-2xl mb-6 shadow-inner flex items-center justify-center">
                {activeTab === "team" ? (
                  <Users size={28} />
                ) : (
                  <Lock size={28} />
              ...
              <h3 className="text-base md:text-lg font-black text-primary uppercase tracking-[0.3em] mb-4">
                {activeTab} Controls
              </h3>
              ...
              <button className="mt-6 px-5 py-3 border-2 border-slate-100 text-slate-400 text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-slate-50 transition-all">
                Request Elevation
              </button>
            </div>
          )}
